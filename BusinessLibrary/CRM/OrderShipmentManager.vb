...
Public Class OrderShipmentManager
    ...
    Public Shared Function GetList(Optional PageIndex As Integer = 0, Optional PageSize As Integer = 0, Optional OrderID As Integer = Nothing, Optional CustomerID As Integer = Nothing, Optional CustomerName As String = Nothing,
                                      Optional DateFrom As String = Nothing, Optional DateTo As String = Nothing, Optional Archived As Boolean? = Nothing) As DataLibrary.OrdersShipment_GetList_Result()
        Using ctx As New DataLibrary.ModelEntities
            Return ctx.OrdersShipment_GetList(PageIndex,
                                         PageSize,
                                         ToNull(OrderID),
                                         ToNull(CustomerID),
                                         ToNull(CustomerName),
